...
checkpointer = ModelCheckpoint(filepath="/home/maths/btech/mt1140594/workspace/VisionProject/scripts/weights_prefeat_lstm2.hdf5", verbose=1, save_best_only=True)
