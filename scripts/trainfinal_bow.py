...
def loadCNNModel():
    ...
    model = Sequential()
    model.add(core.Dense(1024, activation="relu", input_dim=4096))
...
def loadTextModel(vocab_size, MAX_SEQUENCE_LENGTH):
    ...
    textmodel.add(Embedding(input_dim=(vocab_size + 1), input_length=MAX_SEQUENCE_LENGTH, output_dim=1024))
...
checkpointer = ModelCheckpoint(filepath="/home/maths/btech/mt1140594/workspace/VisionProject/scripts/weights_prefeat.hdf5", verbose=1, save_best_only=True)
